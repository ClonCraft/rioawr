...
<div class="p-8 space-y-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <a href="../laporan/laporan_pelanggaran.php" class="group relative bg-[#050a18]/60 border border-white/5 p-8 rounded-[2.5rem] hover:border-emerald-500/50 hover:bg-emerald-500/[0.02] transition-all duration-500 overflow-hidden shadow-2xl">
        ...
        <a href="../laporan/laporan_panggilan.php" class="group relative bg-[#050a18]/60 border border-white/5 p-8 rounded-[2.5rem] hover:border-emerald-500/50 hover:bg-emerald-500/[0.02] transition-all duration-500 overflow-hidden shadow-2xl">
            <div class="w-12 h-12 bg-emerald-500/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-all duration-500">
        ...
        <a href="../laporan/laporan_perjanjian.php" class="group relative bg-[#050a18]/60 border border-white/5 p-8 rounded-[2.5rem] hover:border-emerald-500/50 hover:bg-emerald-500/[0.02] transition-all duration-500 overflow-hidden shadow-2xl">
            <div class="w-12 h-12 bg-emerald-500/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-all duration-500">
        ...
        <a href="../laporan/laporan_pindah.php" class="group relative bg-[#050a18]/60 border border-white/5 p-8 rounded-[2.5rem] hover:border-emerald-500/50 hover:bg-emerald-500/[0.02] transition-all duration-500 overflow-hidden shadow-2xl">
            <div class="w-12 h-12 bg-emerald-500/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-all duration-500">
        ...
        <a href="../laporan/rekap_perjanjian.php" class="group relative bg-[#050a18]/60 border border-white/5 p-8 rounded-[2.5rem] hover:border-emerald-500/50 hover:bg-emerald-500/[0.02] transition-all duration-500 overflow-hidden shadow-2xl md:col-span-2 lg:col-span-1">
            <div class="w-12 h-12 bg-emerald-500/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-all duration-500">
