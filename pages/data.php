...
<div class="p-8 space-y-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <a href="../pelanggaran/data_jenis.php" class="group relative overflow-hidden bg-white/[0.03] border border-white/10 p-8 rounded-[2.5rem] hover:bg-amber-500/5 hover:border-amber-500/50 transition-all duration-500 shadow-2xl">
            <div class="relative z-10 flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-white group-hover:text-amber-400 transition-colors">Data Pelanggaran</h3>
        ...
        <a href="../kelas/data_kelas.php" class="group relative overflow-hidden bg-white/[0.03] border border-white/10 p-8 rounded-[2.5rem] hover:bg-emerald-500/5 hover:border-emerald-500/50 transition-all duration-500 shadow-2xl">
            <div class="relative z-10 flex items-center justify-between">
                <div>
